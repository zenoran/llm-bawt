...
from llm_bawt.memory.extraction.service import MemoryExtractionService, ExtractedFact
...
def _get_extraction_client(config: Config) -> Any:
    ...
    try:
        ...
        # Create a minimal LLMBawt instance for extraction
