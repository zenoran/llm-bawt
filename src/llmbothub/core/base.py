...
BaseLLMBotHub provides the shared logic for both CLI (LLMBotHub) and service
(ServiceLLMBotHub) modes, including:
- Bot initialization
...
class BaseLLMBotHub(ABC):
    ...
    def __init__(
        ...
        """
        if not user_id:
            raise ValueError("user_id is required - set LLMBOTHUB_DEFAULT_USER or pass --user")
