"""Core LLMBotHub class - simple OpenAI-compatible chat client with memory.
...
class LLMBotHub(BaseLLMBotHub):
    ...
    def _initialize_client(self) -> LLMClient:
        ...
        use the background service which has ServiceLLMBotHub.
        """
