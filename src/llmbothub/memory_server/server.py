...
Run standalone:
    uv run python -m llmbothub.memory_server
...
def run_server(
    ...
    verbose_env = os.getenv("LLMBOTHUB_MEMORY_SERVER_VERBOSE", "1").lower()
    debug_env = os.getenv("LLMBOTHUB_MEMORY_SERVER_DEBUG", "0").lower()
