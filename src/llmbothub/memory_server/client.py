...
if TYPE_CHECKING:
    from llmbothub.memory_server.storage import MemoryStorage
...
class MemoryClient:
    ...
    def _ensure_initialized(self) -> None:
        ...
        if self.server_url:
            ...
            from llmbothub.memory_server.storage import get_storage
    ...
    def consolidate_memories(self, dry_run: bool = True, similarity_threshold: float | None = None) -> dict[str, Any]:
        ...
        storage = self._get_storage()
        backend = storage.get_backend(self.bot_id)
        from llmbothub.memory.consolidation import MemoryConsolidator, get_local_llm_client
    ...
    def extract_facts(
        ...
        from llmbothub.memory_server.extraction import extract_facts_from_messages
    ...
    def _call_server(self, method: str, params: dict) -> Any:
        ...
        request_id = None
        try:
            from llmbothub.service.logging import get_request_id  # type: ignore
        ...
        try:
            from llmbothub.service.logging import get_service_logger
