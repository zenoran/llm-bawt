...
from llmbothub.memory.embeddings import generate_embedding
from llmbothub.utils.config import Config

if TYPE_CHECKING:
    from llmbothub.memory.postgresql import PostgreSQLShortTermManager
...
class MemoryStorage:
    ...
    async def update_memory_meaning(
        ...
        if not memory_id:
            return False
        from llmbothub.memory.maintenance import update_memory_meaning
    ...
    async def run_maintenance(
        ...
        from llmbothub.memory.maintenance import MemoryMaintenance
