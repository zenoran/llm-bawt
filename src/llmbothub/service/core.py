"""Service-side LLMBotHub class - supports loading local models (GGUF, etc.)
...
from ..core.base import BaseLLMBotHub
...
class ServiceLLMBotHub(BaseLLMBotHub):
    ...
    def prepare_messages_for_query(self, prompt: str) -> list[Message]:
        ...
        # The ServiceLLMBotHub instance is cached across requests, so in-memory
