...
DEFAULT_SOCKET_PATH = Path.home() / ".cache" / "llmbothub" / "service.sock"
...
class ServiceClient:
    """
    Client for communicating with the llmbothub background service.
    ...
    async def _request_async(
        ...
        if not HTTPX_AVAILABLE:
            raise RuntimeError("httpx not available. Install with: pip install llmbothub[service]")
