...
from llmbothub.utils.config import Config, set_config_value
from llmbothub.utils.env import set_env_value
...
def run_config_wizard(config: Config, console: Console) -> int:
    ...
    console.print(Panel.fit("llmbothub Config Wizard", border_style="cyan"))
