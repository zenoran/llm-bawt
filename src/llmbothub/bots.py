...
with user overrides from ~/.config/llmbothub/bots.yaml taking priority.
"""
...
def get_user_bots_yaml_path() -> Path:
    """Get the path to user bots.yaml (~/.config/llmbothub/bots.yaml)."""
    from llmbothub.utils.config import get_default_config_dir
