#!/usr/bin/env python3
"""
Memory management CLI tool for llmbothub.
...
def handle_regenerate_embeddings(bot_id: str):
    ...
    if result.get("success"):
        ...
        console.print("Install with: [cyan]pipx runpip llmbothub install sentence-transformers[/cyan]")
...
def main():
    parser = argparse.ArgumentParser(
        description="Memory and message history management for llmbothub",
