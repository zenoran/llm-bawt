"""Migration utilities for llmbothub memory schema changes.

Run from command line:
    python -m llmbothub.memory.migrations backfill_meaning --bot nova
    python -m llmbothub.memory.migrations all --bot nova

Or import and use programmatically:
    from llmbothub.memory.migrations import run_all_migrations
